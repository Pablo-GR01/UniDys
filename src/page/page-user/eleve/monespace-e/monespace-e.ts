...
import { MesCoursE, MesCoursComponent } from "../../../../component-page/Eleve/mes-cours-e/mes-cours-e";

@Component({
  selector: 'app-monespace-e',
  standalone: true,
  imports: [CommonModule, Entete5E, HeaderE, Section5E, MesCoursE, MesCoursComponent],
